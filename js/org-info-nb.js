...
}d.LINKS+=((d.LINK_UP&&d.LINK_UP!=document.URL)?'<a href="'+d.LINK_UP+'">Up</a> / ':"")+((d.LINK_HOME&&d.LINK_HOME!=document.URL)?'<a href="'+d.LINK_HOME+'">HOME</a> / ':"")+'<a href="javascript:org_html_manager.showHelp();">HJELP</a> / ';
...
var e=0;for(var d=0;d<this.S.length;++d){this.S[d].J=d;var c='<table class="org-info-js_info-navigation" width="100%" border="0" style="border-bottom:1px solid black;"><tr><td colspan="3" style="text-align:left;border-style:none;vertical-align:bottom;"><span style="float:left;display:inline;text-align:left;">Topp: <a accesskey="t" href="javascript:org_html_manager.go(0);">'+f+'</a></span><span style="float:right;display:inline;text-align:right;font-size:70%;">'+this.LINKS+'<a accesskey="m" href="javascript:org_html_manager.toggleView('+d+');">toggle view</a></span></td></tr><tr><td style="text-align:left;border-style:none;vertical-align:bottom;width:22%">';
if(d>0){c+='<a accesskey="p" href="'+this.S[d-1].L+'" title="Go to: '+this.rT(this.S[d-1].H.innerHTML)+'">Forrige</a> | ';
}else{c+="Forrige | ";}if(d<this.S.length-1){c+='<a accesskey="n" href="'+this.S[d+1].L+'" title="Go to: '+this.rT(this.S[d+1].H.innerHTML)+'">Neste</a>';
}else{c+="Neste";}c+='</td><td style="text-align:center;vertical-align:bottom;border-style:none;width:56%;">';
...
if("underline"==this.MOUSE_HINT){this.S[a].H.style.borderBottom="";}else{this.S[a].H.style.backgroundColor="";
		       ...
		       if(a.Hg){a.LVM=a.VIEW;if(a.PLAIN_VIEW==a.VIEW){a.iV(true);}a.W.innerHTML='Trykk hvilken som helst knapp eller <a href="javascript:org_html_manager.showHelp();">trykk her</a> for å fortsette.<h2>Tastatursnarveier</h2><table cellpadding="3" rules="groups" frame="hsides" style="caption-side:bottom;margin:20px;border-style:none;" border="0";><caption><small>org-info.js, v. 0.1.7.1</small></caption><tbody><tr><td><code><b>? / &iquest;</b></code></td><td>vis denne hjelpeskjermen</td></tr></tbody><tbody><tr><td><code><b></b></code></td><td><b>Bevege seg rundt</b></td></tr><tr><td><code><b>n / p</b></code></td><td>gå til neste / forrige seksjon</td></tr><tr><td><code><b>N / P</b></code></td><td>gå til neste / forrige sibling</td></tr><tr><td><code><b>t / E</b></code></td><td>gå til første / siste seksjon</td></tr><tr><td><code><b>g</b></code></td><td>gå til seksjon...</td></tr><tr><td><code><b>u</b></code></td><td>gå opp ett nivå (parent seksjon)</td></tr><tr><td><code><b>i / C</b></code></td><td>vis innholdsfortegnelse / tags-indeks</td></tr><tr><td><code><b>b / B</b></code></td><td>gå tilbake til forrige / neste besøkte seksjon</td></tr><tr><td><code><b>h / H</b></code></td><td>gå til indeks i denne siden / link til HJEMME</td></tr></tbody><tbody><tr><td><code><b></b></code></td><td><b>View</b></td></tr><tr><td><code><b>m / x</b></code></td><td>endre mellom informativ og enkel visning</td></tr><tr><td><code><b>f / F</b></code></td><td>fold nåværende seksjon / dokument (kun i enkel visning)</td></tr></tbody><tbody><tr><td><code><b></b></code></td><td><b>Søking</b></td></tr><tr><td><code><b>s / r</b></code></td><td>søk framover / bakover....</td></tr><tr><td><code><b>S / R</b></code></td><td>søk igjen framover / bakover</td></tr><tr><td><code><b>o</b></code></td><td>occur-modus</td></tr><tr><td><code><b>c</b></code></td><td>klarer søke-markering</td></tr></tbody><tbody><tr><td><code><b></b></code></td><td><b>Ymse</b></td></tr><tr><td><code><b>l / L / U</b></code></td><td>vis HTML-lenke / Org-lenke / enkel-URL</td></tr><tr><td><code><b>v / V</b></code></td><td>skroll nedover / oppover</td></tr><tr><td><code><b>W</b></code></td><td>Print</td></tr></tbody></table><br />Trykk hvilken som helst knapp eller <a href="javascript:org_html_manager.showHelp();">trykk her</a> for å fortsette.';
